...
class LogisticRegressionClassifier(BaseWeakLearner):
    ...
    def __init__(self, learning_rate=0.1, n_iterations=1000, tol=1e-12):
        super().__init__()
    ...
    def fit(self, X, y, weights):
        ...
        for _ in range(self.n_iterations):
            ...
            db = (1/n_samples) * np.sum((y_binary - y_pred) * weights)
            ...
            # 检查收敛
            if np.mean(np.abs(self.weights - self.bias)) < self.tol:
                break
